...
#
# This is based on chainer examples wavenet generate.py in <https://github.com/chainer/chainer/tree/master/examples/wavenet>
...
# Preprocess
_, condition, _ , _ = Preprocess(  # add _ as w
